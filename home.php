				...
				<div class="col-md-8"  style=" height:100%">
						...
						<div class="col-md-12">
							<ul class="nav nav-pills">
								<a style="display: inline;"><a class="btn btn-primary" href ="#" onclick="load('sonos/queue.php')">Play Queue</a>
									<a style="display: inline;"><a class="btn btn-primary" href ="#" onclick="load('tabletemplate.php')">Activity History</a></a>
					...
					<div class="col-md-4" style=" height:200%">
						<div class="panel panel-primary" >
							...
							<div class="panel-body">
								<object width="100%" style=" height:95%" type="text/html" data='spotifySearch.php' ></object>
							</div>
						</div>
					</div>
				</div>
