<?php
    ...
    if(isset($_GET['code']))
    {
        ...
        if($exists == 1)
        {
            ...
            $stmt->bind_param('sss', $fName, $sName, $id);//need to alter table and tell muhammad
            $stmt->execute();
        ...
        else
        {
            ...
            $url = "http://" . $_SERVER['HTTP_HOST'] . "/register.php?id=" . $id . "&dName=" . $dName . "&fName=" . $fName . "&sName=" . $sName . "&email=" . $email;
            header("Location: $url");
        }    
    }
    else
