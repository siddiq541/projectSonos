		...
		<div class="section section-primary" style="padding-bottom: 0px; padding-top: 10px;">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-1"><a href="#"><img src="resources/ideagen-logo.svg"
						 class="img-responsive"></a></div><div class="col-md-1"><a href="#">
						 <img src="resources/sonos-logo.jpg" class="img-responsive"></a></div><div 
						 class="col-md-1"><a href="#"><img src="resources/spotify-logo.jpg" 
