...
<html>
    ...
    <div class="MusicPLayer">
        ...
        <object width="100%" style="height:25%" type="text/html" data='  ' ></object>
    </div>
    ...
    <ul class="navigation" style="padding: 0;">
        <li style="display: inline;"><a href ="#" onclick="load('tabletemplate.html')">Play Queue</a></li>
    ...
    <table height="45%">
        <tr height="100%">
            ...
            <td width="25%"><div style="padding:0;height:100%"><object width="100%" style="height:100%" type="text/html" data='spotifytest.php' ></object></div></td>
        </tr>
    </table>
    ...
    <script>
        ...
        load('tabletemplate.html');//Default.
    </script>
